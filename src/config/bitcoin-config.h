...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Scoutcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Scoutcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/scoutcoin-project/scoutcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Scoutcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Scoutcoin Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "scoutcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://scoutcoin.org/"
