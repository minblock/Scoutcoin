...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " scoutcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  scoutcoin-tx [options] <hex-tx> [commands]  Update hex-encoded scoutcoin transaction\n" +
            "or:     scoutcoin-tx [options] -create [commands]   Create hex-encoded scoutcoin transaction\n" +
            "\n";
