...
"""Verify that starting scoutcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start scoutcoin with -h for help text")
        ...
        self.log.info("Start scoutcoin with -version for version information")
        ...
        self.log.info("Start scoutcoind with -fakearg to make sure it does not start")
