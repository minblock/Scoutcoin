...
pkgdatadir = $(datadir)/scoutcoin
pkgincludedir = $(includedir)/scoutcoin
pkglibdir = $(libdir)/scoutcoin
pkglibexecdir = $(libexecdir)/scoutcoin
...
ACLOCAL = ${SHELL} /scoutcoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /scoutcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /scoutcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /scoutcoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = scoutcoin-cli
BITCOIN_DAEMON_NAME = scoutcoind
BITCOIN_GUI_NAME = scoutcoin-qt
BITCOIN_TX_NAME = scoutcoin-tx
BITCOIN_WALLET_TOOL_NAME = scoutcoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The Scoutcoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Scoutcoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /scoutcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = scoutcoin
PACKAGE_BUGREPORT = https://github.com/scoutcoin-project/scoutcoin/issues
PACKAGE_NAME = Scoutcoin Core
PACKAGE_STRING = Scoutcoin Core 0.18.1
PACKAGE_TARNAME = scoutcoin
PACKAGE_URL = https://scoutcoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /scoutcoin
abs_srcdir = /scoutcoin
abs_top_builddir = /scoutcoin
abs_top_srcdir = /scoutcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /scoutcoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Scoutcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Scoutcoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Scoutcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Scoutcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
