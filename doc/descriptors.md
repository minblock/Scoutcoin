# Support for Output Descriptors in Scoutcoin Core

Since Scoutcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Scoutcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Scoutcoin Core wallets, a convenience function `combo` is
