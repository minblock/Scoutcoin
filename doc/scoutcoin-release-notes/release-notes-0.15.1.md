Scoutcoin Core version *0.15.1* is now available from:

  <https://download.scoutcoin.org/scoutcoin-0.15.1/>
...
A number of changes to the way Scoutcoin Core deals with peer connections and invalid blocks
